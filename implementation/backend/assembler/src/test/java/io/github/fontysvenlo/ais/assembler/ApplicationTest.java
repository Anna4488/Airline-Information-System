 ...
 * We do inject our own configuration objects rather than reading them from
 * properties files.
 *
 * We use Rest Assured to write the integrated tests, which allows us to use
 * Given-When-Then.
 */
  ...
  DBConfig dbConfig = new DBConfig("test", postgres.getHost(),
